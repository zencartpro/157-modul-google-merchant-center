 ...
 * @version $Id: tpl_product_info_display.php for Google Merchant Center 2022-02-23 20:30:40Z webchills $
 */
...
<ul id="productDetailsList">
  ...
  <?php echo (($flag_show_product_info_ean == 1 and $products_ean !='') ? '<li>' . TEXT_PRODUCT_EAN . $products_ean . '</li>' : '') . "\n"; ?>
   <?php echo (($flag_show_product_info_isbn == 1 and $products_isbn !='') ? '<li>' . TEXT_PRODUCT_ISBN . $products_isbn . '</li>' : '') . "\n"; ?>
   <?php echo (($flag_show_product_info_brand == 1 and $products_brand !='') ? '<li>' . TEXT_PRODUCT_BRAND . $products_brand . '</li>' : '') . "\n"; ?>
