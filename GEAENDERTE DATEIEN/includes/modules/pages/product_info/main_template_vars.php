 ...
 * @version $Id: main_template_vars.php for GMCDE 2022-02-23 20:19:36Z webchills $
 */
/*
...
// if review must be approved or disabled do not show review
  ...
  $products_ean = $product_info->fields['products_ean'];
  $products_isbn = $product_info->fields['products_isbn'];
  $products_brand = $product_info->fields['products_brand'];
  $products_availability = $product_info->fields['products_availability'];
...
// build show flags from product type layout settings
  ...
  $flag_show_product_info_ean = zen_get_show_product_switch($_GET['products_id'], 'ean');
  $flag_show_product_info_isbn = zen_get_show_product_switch($_GET['products_id'], 'isbn');
  $flag_show_product_info_brand = zen_get_show_product_switch($_GET['products_id'], 'brand');
