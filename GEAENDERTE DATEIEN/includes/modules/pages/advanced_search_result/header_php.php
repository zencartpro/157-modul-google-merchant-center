 ...
 * @version $Id: header_php.php for EAN and ISBN 2022-02-23 20:17:20Z webchills $
 */
...
$select_str = "SELECT DISTINCT " . $select_column_list .
              " p.products_sort_order, m.manufacturers_id, p.products_id, p.products_ean, p.products_isbn, pd.products_name, p.products_price, p.products_tax_class_id, p.products_price_sorter, p.products_qty_box_status, p.master_categories_id, p.product_is_call ";
